...
class CareerGuidanceSystem:
    def __init__(self, google_api_key=None, serpapi_key=None):
    ...
    def search_career_information(self, career):
        ...
        if self.search_agent:
            ...
            result = self.search_with_cache(query, f"{career}_info")
    ...
    def analyze_market_trends(self, career):
        ...
        if self.search_agent:
            ...
            result = self.search_with_cache(query, f"{career}_market")
    ...
    def create_learning_roadmap(self, career, experience_level="beginner"):
        ...
        if self.search_agent:
            ...
            result = self.search_with_cache(query, f"{career}_roadmap_{experience_level}")
    ...
    def get_career_insights(self, career):
        ...
        if self.search_agent:
            ...
            result = self.search_with_cache(query, f"{career}_insights")
