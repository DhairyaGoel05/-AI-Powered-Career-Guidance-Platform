...
with st.sidebar:
    ...
    google_api_key = st.text_input("Google API Key", type="password", value=st.session_state.google_api_key, help="Get your key from https://aistudio.google.com/")
...
with st.expander("ℹ️ About this AI Career Guidance System"):
    ...
    For the best experience, enter your Google API key and SerpAPI key in the sidebar.
    """)